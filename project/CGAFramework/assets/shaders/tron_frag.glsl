...
in vec2 tc0;
in vec3 Normal, toLight, toCamera, spotLight,  toLight2, toLight3, toLight4, toLight5;
...
uniform vec3 PointLight2Color, PointLight2AttenuationFactors;
uniform vec3 PointLight3Color, PointLight3AttenuationFactors;
uniform vec3 PointLight4Color, PointLight4AttenuationFactors;
uniform vec3 PointLight5Color, PointLight5AttenuationFactors;
...
void main(){
    ...
    color += vec4(calculatePointLights(Normal, toLight2, toCamera, PointLight2Color, PointLight2AttenuationFactors, material.shininess), 1.0f);
    color += vec4(calculatePointLights(Normal, toLight3, toCamera, PointLight3Color, PointLight3AttenuationFactors, material.shininess), 1.0f);
    color += vec4(calculatePointLights(Normal, toLight4, toCamera, PointLight4Color, PointLight4AttenuationFactors, material.shininess), 1.0f);
    color += vec4(calculatePointLights(Normal, toLight5, toCamera, PointLight5Color, PointLight5AttenuationFactors, material.shininess), 1.0f);
